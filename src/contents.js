module.exports = {
  profile: {
    ...
    links: [
      { name: "github", href: "https://github.com/skyoun97" },
      {
        name: "portfolio",
        href:
          "https://www.notion.so/hyeonss/Hyeonseong-Jeon-89d4aa4039b748dfbcf08863cf0c88e8",
      },
    ],
  },
  contents: {
    "Skill Set": [
      ...
      },
      {
        date: "Knowledgeable",
        title:
          "Adobe XD / Git & Github / React Native / Amazon S3 / Heroku / Spring / TensorFlow / NLP / Word2Vec / ELMo",
        contents: [""],
      },
    ],
    "개인 프로젝트": [
      {
        ...
        title: "[Hyeonstagram] 인스타그램 풀스택 클론코딩",
        contents: [
          "- 앱, 프론트엔드, 백엔드 모두 클론 코딩하여 사진 촬영, 사진 업로드, 피드, 피드 검색, 좋아요, 팔로잉, 알림, 메시지 보내기 등 인스타그램의 거의 모든 기능을 구현했습니다.",
          "- Frontend & App: React, Apollo, Hooks, React Native, Expo",
          "- Backend: NodeJS, Express, GraphQL, Prisma, Heroku, S3",
          '- <a href="https://github.com/skyoun97/Hyeonstagram-frontend">Frontend Git Repository</a>',
          '- <a href="https://github.com/skyoun97/Hyeonstagram-app">App Git Repository</a>',
          '- <a href="https://github.com/skyoun97/Hyeonstagram-backend">Backend Git Repository</a>',
        ],
      },
      {
        date: "2020.05 - 2020.06",
        title: "[AgentBlog] Velog 풀스택 클론코딩 (2인 개발)",
        contents: [
          "- 개발자들을 위한 블로그 서비스인 velog를 프론트엔드, 벡엔드 모두 클론코딩하여 Markdown 기반 게시물 작성, 해시태그 설정, 게시물 검색, 해시태그 검색, 반응형디자인 등 대부분의 기능을 구현했습니다.",
          "- Frontend: React, TypeScript, Apollo, Hooks",
          "- Backend: NodeJS, Express, GraphQL, Prisma, Heroku, S3",
          '- <a href="https://github.com/skyoun97/AgentBlog">Frontend Git Repository [기여 60%]</a>',
          '- <a href="https://github.com/skyoun97/AgentBlog-backend">Backend Git [기여 100%] Repository</a>',
          "- 협업: 총 150번 이상의 commit. 40번 이상의 Pull request.",
        ],
      },
    ],
    "개인 활동": [
  ...
  detailContents: {
    ...
    "ONE MOMENT (원모먼트)": {
      ...
      info:
        "90분 당일 꽃배달 서비스 “원모먼트 플라워” 를 서비스 중인 스타트업.",
      service: [
    ...
    "ATEAM VENTURES (에이팀벤쳐스)": {
      ...
      info:
        "3D Printer 공유 플랫폼 사이트 “ShapEngine” 을 서비스 중인 스타트업.",
      service: [
        `Web<br />
